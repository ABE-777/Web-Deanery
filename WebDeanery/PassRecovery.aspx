...
top: -15px;
    ...
    <div id="LoginValidator" style="text-align:left; width: 410px;">
        <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" 
            ...
            ForeColor="#D9AC29" Font-Bold="True" Font-Size="Large" >Type your login                                           </asp:RequiredFieldValidator>
        <style type="text/css">
...
margin:0 auto;position:relative;width:414px;
    ...
    &nbsp;<asp:ImageButton  
                 ID="SubmitButton" runat="server" CssClass="RightArrow" 
                 ImageUrl="/Resources/Login/restore.jpg" onmouseout="this.src='/Resources/Login/restore.jpg'" 
                 onmouseover="this.src='/Resources/Login/restore1.jpg'" 
             ValidationGroup="PasswordRecovery" Height="39px" 
            Width="125px" CommandName="Submit"  />
        
        <style type="text/css">
            #SubmitButtonDiv{background:none 0 0 no-repeat;height:20px;margin:0 auto;position:relative;width:414px;
            top: -193px
            }
            </style>
            </div>
    ...
    <asp:Literal ID="FailureText" runat="server" EnableViewState="False" ></asp:Literal>
        <style type="text/css">
            #LoginResult{background:none 0 0 no-repeat;height:23px; 
margin:0 auto;position:relative;width:414px;
            top: -165px
            }
            </style>
             ...
             <div id="Label" style="text-align:center">
                <asp:Label ID="Label1" runat="server" 
                    Text="The password will be sent to your email" Font-Bold="True" 
                    Font-Size="Large" ForeColor="#72241F"></asp:Label>
                 
                  <asp:ImageButton  
                 ID="ContinueButton" runat="server" CssClass="RightArrow" 
                 ImageUrl="/Resources/Login/continue.jpg" onmouseout="this.src='/Resources/Login/continue.jpg'" 
                 onmouseover="this.src='/Resources/Login/continue1.jpg'" Height="39px" 
            Width="125px" CommandName="Submit"  PostBackUrl="~/Default.aspx" />
        
            <style type="text/css">
            #ContinueButton{background:none 0 0 no-repeat;height:20px;margin:0 auto;position:relative;width:414px;
            top: -193px
            }
            </style>
            ...
            <style type="text/css">
            #Label{background:none 0 0 no-repeat;height:20px;margin:0 auto;position:relative;width:414px;
            top: -155px
                }
            </style>
             </div>
