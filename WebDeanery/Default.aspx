...
<head runat="server">
    <title>Welcome!</title>
    <style type="text/css">
        #Login_box {background:url(/Resources/Login/LoginText.png) 0 0 no-repeat;height:43px;margin:0 auto;position:relative;width:414px;top: -257px;left: 1px;}
        ...
        #UserName {width: 404px;}
        #LoginValidator {height: 45px; margin: 0 auto; position: relative; width: 414px; top: -254px; left: 0px; }  
        #Password_box {background:url(/Resources/Login/LoginText.png) 0 0 no-repeat;height:43px;margin:0 auto;position:relative;width:414px;top: -257px;left: 1px; }
        #Password_box input{border-style:  none; border-color: inherit;  border-width: 0; font-family:Tahoma,Arial,Helvetica,sans-serif;font-size:25px;line-height:16px;margin:7px 0 4px 8px; outline:none;padding:2px;width:396px; top: -15px; left: 265px; -webkit-appearance:none;-webkit-border-radius:0; height: 30px;}
        #Password_box img {float:right;margin:0 0 0 0;}
        #PasswordValidator{background:none 0 0 no-repeat;height:20px;margin:0 auto;position:relative;width:414px; top: -255px}
        #RememberCheck{background:none 0 0 no-repeat;height:20px;margin:0 auto;position:relative;top: -240px}
        #LoginButtonDiv{background:none 0 0 no-repeat;height:2px;margin:0 auto;position:relative;width:414px;top: -257px}      
        #LoginResult{background:none 0 0 no-repeat;height:2px; margin:0 auto;position:relative;width:414px;top: -165px}
    </style>
</head>
<body>
    ...
    &nbsp;<asp:LinkButton ID="LinkButton1" runat="server" 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <asp:ImageButton  
            ...
            ValidationGroup="Login1" CommandName="Login"/>
            </div>
